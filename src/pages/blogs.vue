<template>
  <Layout>
    <div class="mt-8 mb-16 flex justify-center"><blog-icon /></div>

    <h3 class="mt-8 text-lg text-center" style="color: #03a87c">
      בלוגים בעברית
    </h3>
    <div
    ...
    >
      <blog-card
        v-for="blog in blogsHebrew"
        :key="blog.name"
        v-bind="blog.node"
      />
    </div>
    <h3 style="color: #03a87c" class="mt-32 text-lg text-center">
      בלוגי Medium
    </h3>
    <div
      class="ltr max-w-4xl mx-auto my-6 flex flex-wrap justify-center items-center"
    ...
    <section class="flex flex-col items-center mb-8">
      <h1 class="mt-8 p-4 text-custom-text-primary">
        ידוע לכם על בלוג מקצועי מוצלח (בעברית)?
      </h1>
      <g-link to="/contact">
        <button
